...
data1;
  ...
  public radarChartLabels: Label[] = ['January',  'Febrauary', 'March', 'April',  'May'];

  public radarChartData: ChartDataSets[] = [
    { data: [65, 59,  56, 55, 40], label: 'Series A' },
    { data: [28, 48,  96, 27, 100], label: 'Series B' }
  ];
  ...
  public chartHovered({ event, active }: { event: MouseEvent, active: {}[] }): void {
   ...
   // PolarArea
   public polarAreaChartLabels: Label[] = ['Red', 'Green', 'Yellow' ];
   public polarAreaChartData: SingleDataSet = [300, 50, 100];
